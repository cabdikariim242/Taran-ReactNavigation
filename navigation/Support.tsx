      ...
      <ScrollView className="w-full h-[560px]">
        ...
        <View className="flex flex-col justify-start gap-2  items-start w-full">
          ...
          <Text className="font-[500] text-[17px] text-[#0C4C7B] text-start w-[321px]    ">
            If you need any help please contact us our WhatsApp number by
            clicking the bellow button or our call center, Thanks .
          </Text>
        </View>
        {/* First card */}
        <View className="flex-row gap-4 justify-center items-center  mt-3">
          ...
          <View className="flex justify-center items-center w-[95px] h-[80] bg-white rounded-[12px] ">
            <View className="flex-row gap-2">
              ...
              <Text className="text-[#0C4C7B] font-bold text-[12px] w-[30px] ">
                Call Center
              </Text>
            </View>
